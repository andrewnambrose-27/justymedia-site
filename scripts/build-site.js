...
function header(pagePath) {
  ...
  return `<a class="skip-link" href="#main-content">Skip to main content</a>
    <header class="site-header">
      <div class="top-strip"><div class="social-links"><a href="https://www.instagram.com/justymedia/" aria-label="Justy Media on Instagram" rel="me">${socialIcon("instagram")}</a><a href="https://www.facebook.com/justymedia/" aria-label="Justy Media on Facebook" rel="me">${socialIcon("facebook")}</a></div><a class="email-link" href="mailto:${email}">${email}</a></div>
...
function footer() {
  return `<footer class="site-footer">
    ...
    <div><p class="footer-heading">Justy Media</p><nav aria-label="Footer information"><a href="/about-us/">About</a><a href="/contact-us/">Contact</a><a href="/image-licensing/">Image licensing</a><a href="/privacy-policy.html">Privacy policy</a><a href="/terms-and-conditions.html">Terms and conditions</a></nav><div class="footer-socials"><a href="https://www.instagram.com/justymedia/" aria-label="Instagram">${socialIcon("instagram")}</a><a href="https://www.facebook.com/justymedia/" aria-label="Facebook">${socialIcon("facebook")}</a></div></div>
